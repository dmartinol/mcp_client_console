...
class StdioConnection(MCPConnection):
    ...
    async def connect(self) -> Dict[str, Any]:
        ...
        try:
            ...
            async with stdio_client(self.server_params) as (read, write):
                async with MCPClientSession(read, write) as session:
                    ...
                    try:
                        ...
                        server_info['tools'] = tools_result.tools if tools_result else []
                    ...
                    try:
                        ...
                        server_info['prompts'] = prompts_result.prompts if prompts_result else []
                    except Exception as e:
                    ...
                    try:
                        ...
                        server_info['resources'] = resources_result.resources if resources_result else []
                    except Exception as e:
            ...
            raise ConnectionError(f"Failed to connect via STDIO: {str(e)}") from e
