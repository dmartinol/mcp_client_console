...
class ErrorHandler:
    ...
    def _analyze_error(error: Exception, error_message: str) -> Dict[str, Any]:
        ...
        if "Invalid URL" in error_message or "urlparse" in error_message.lower():
            ...
            analysis["suggestions"].append("Check that the URL is properly formatted with protocol (http:// or https://)")
            analysis["suggestions"].append("Ensure the URL doesn't contain invalid characters")
        ...
        # Connection errors
        elif any(keyword in error_message.lower() for keyword in ["connection", "timeout", "refused", "unreachable"]):
        ...
        # JSON/parsing errors
        elif any(keyword in error_message.lower() for keyword in ["json", "parse", "decode"]):
        ...
        # Permission errors
        elif any(keyword in error_message.lower() for keyword in ["permission", "access", "denied", "unauthorized"]):
        ...
        # File system errors
        elif any(keyword in error_message.lower() for keyword in ["file not found", "no such file", "directory"]):
        ...
        # Tool execution errors
            ...
            analysis["suggestions"].append("Verify tool is available and properly configured")
