...
from .models import (
    ServerInfo, ToolInfo, PromptInfo, ResourceInfo, 
    ConnectionConfig, ToolExecutionResult
)
...
class MCPClientService:
    ...
    async def connect(self, connection_config: ConnectionConfig) -> ServerInfo:
        ...
        """
        try:
            logger.info(f"Connecting to MCP server via {connection_config.connection_type}")
